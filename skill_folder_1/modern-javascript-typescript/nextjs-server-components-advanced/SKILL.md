---
name: nextjs-server-components-advanced
description: Nextjs Server Components Advanced
---

# Nextjs Server Components Advanced

## Core Concepts

Key concepts and definitions for nextjs-server-components-advanced.
