---
name: godot-metroidvania-backtracking-pacing
description: Godot Metroidvania Backtracking Pacing
---

# Godot Metroidvania Backtracking Pacing

## Core Concepts
Reward backtracking with shortcuts and new routes.
- Place one-way gates early.
- Open new path with acquired ability.
