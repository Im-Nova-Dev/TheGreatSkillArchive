---
name: godot-genre-tutorial-card-battle-yugioh
description: Godot Genre Tutorial Card Battle Yugioh
---

# Godot Genre Tutorial Card Battle Yugioh

## Core Concepts
Card battle system tutorial.
1. Card data model.
2. Hand, field, and deck zones.
3. Turn state machine.
4. Targeting and resolution.
