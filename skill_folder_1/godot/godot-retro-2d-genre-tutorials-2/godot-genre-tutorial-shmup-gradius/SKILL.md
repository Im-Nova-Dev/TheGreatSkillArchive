---
name: godot-genre-tutorial-shmup-gradius
description: Godot Genre Tutorial Shmup Gradius
---

# Godot Genre Tutorial Shmup Gradius

## Core Concepts
Gradius-style side-scrolling shooter.
1. Powerup bar system (speed, weapon, shield, etc.).
2. Formation enemies.
3. Boss with destructible parts.
4. Checkpoint and continue.
5. Level editor data format.
6. Multiple weapon types (laser, missile, double).
