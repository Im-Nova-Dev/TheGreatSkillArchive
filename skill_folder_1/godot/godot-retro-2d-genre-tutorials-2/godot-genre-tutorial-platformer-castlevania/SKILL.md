---
name: godot-genre-tutorial-platformer-castlevania
description: Godot Genre Tutorial Platformer Castlevania
---

# Godot Genre Tutorial Platformer Castlevania

## Core Concepts
Classic Castlevania tutorial.
1. Whip upgrade.
2. Subweapons (axe, dagger, holy water).
3. Stairs and vertical movement.
4. Boss fight with pattern.
5. Map reveal.
6. Time attack mode.
