---
name: godot-genre-tutorial-platformer-mega-man
description: Godot Genre Tutorial Platformer Mega Man
---

# Godot Genre Tutorial Platformer Mega Man

## Core Concepts
Classic Mega Man-style tutorial.
1. Run and jump with variable height.
2. Charged shot mechanic.
3. Enemy types with weak points.
4. Stage select screen.
5. Boss weapon acquisition.
6. Death and respawn.
