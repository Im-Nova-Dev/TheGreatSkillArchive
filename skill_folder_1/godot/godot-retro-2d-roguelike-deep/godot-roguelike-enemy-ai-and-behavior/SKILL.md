---
name: godot-roguelike-enemy-ai-and-behavior
description: Godot Roguelike Enemy Ai And Behavior
---

# Godot Roguelike Enemy Ai And Behavior

## Core Concepts
Simple enemy AI.
- Idle patrol (random walk)
- Alert when player seen (FOV)
- Chase and lose interest behind walls
