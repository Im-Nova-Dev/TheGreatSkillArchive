---
name: godot-tutorial-retro-tower-defense
description: Godot Tutorial Retro Tower Defense
---

# Godot Tutorial Retro Tower Defense

## Core Concepts
Tower defense tutorial outline.
1. Path and waves.
2. Tower placement grid.
3. Projectile targeting.
4. Economy (gold per kill).
5. Tower upgrades.
