---
name: godot-tutorial-retro-typing-type-r
description: Godot Tutorial Retro Typing Type R
---

# Godot Tutorial Retro Typing Type R

## Core Concepts
Typing game tutorial.
1. Words falling or scrolling.
2. Input capture and match.
3. Score multiplier and combo.
4. Difficulty ramping.
5. Sound and visual feedback.
6. High score table.
