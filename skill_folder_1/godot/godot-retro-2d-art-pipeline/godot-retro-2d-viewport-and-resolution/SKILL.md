---
name: godot-retro-2d-viewport-and-resolution
description: Godot Retro 2D Viewport And Resolution
---

# Godot Retro 2D Viewport And Resolution

## Core Concepts
Fixed resolution with stretch.
```gdscript
# Project settings:
