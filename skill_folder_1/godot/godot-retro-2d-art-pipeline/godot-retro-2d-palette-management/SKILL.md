---
name: godot-retro-2d-palette-management
description: Godot Retro 2D Palette Management
---

# Godot Retro 2D Palette Management
...
const MAIN := Palette.new()
MAIN.colors = [
    Color("#1a1c2c"), Color("#5d275d"), Color("#b13e53"),
    Color("#ef7d57"), Color("#ffcd75"), Color("#a7f070")
]
```
