---
name: godot-contra-spread-shot
description: Godot Contra Spread Shot
---

# Godot Contra Spread Shot

## Core Concepts
Multi-directional bullets.
```gdscript
class_name SpreadGun extends Node2D

func fire() -> void:
    for angle in [-30, -15, 0, 15, 30]:
        spawn_bullet(deg_to_rad(angle))
```
