---
name: godot-learning-monetization
description: Godot Learning Monetization
---

# Godot Learning Monetization

## Core Concepts

## Core Concepts
Retro game monetization basics.
- Itch.io: pay-what-you-want
- Steam: store page, trailers, screenshots
- Patreon / Ko-fi for support
- Itch.io and Steam keys for giveaways
