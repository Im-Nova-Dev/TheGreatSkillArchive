---
name: godot-learning-export-and-distribution
description: Godot Learning Export And Distribution
---

# Godot Learning Export And Distribution

## Core Concepts

## Core Concepts
Exporting and shipping.
- Export templates (install via Editor)
- Multiple presets
- HTML5 with shared workers or wasm
- Steam integration (Steamworks.NET via GDExtension or gdgames)
- Itch.io Butler
