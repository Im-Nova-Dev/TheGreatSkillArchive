---
name: godot-genre-tutorial-visual-novel
description: Godot Genre Tutorial Visual Novel
---

# Godot Genre Tutorial Visual Novel
...
VN engine in Godot.
```gdscript
class_name VNLine extends Resource
