---
name: godot-gdscript-type-system-deep
description: Godot Gdscript Type System Deep
---

# Godot Gdscript Type System Deep

## Core Concepts
Typed GDScript best practices.
- Use `Array[Type]`, `Dictionary[Key, Value]`.
- Prefer `PackedScene`, `Resource`, `Node2D` over Variant.
- Use `@icon` for custom nodes.
