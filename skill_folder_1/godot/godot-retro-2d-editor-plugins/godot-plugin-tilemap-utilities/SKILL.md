---
name: godot-plugin-tilemap-utilities
description: Godot Plugin Tilemap Utilities
---

# Godot Plugin Tilemap Utilities

## Core Concepts
Custom TileMap editor plugin.
```gdscript
@tool
extends EditorPlugin

func _enter_environment() -> void:
    pass

func populate_tileset() -> void:
    pass
```
