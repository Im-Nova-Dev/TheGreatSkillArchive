---
name: godot-states-statechart
description: Godot States Statechart
---

# Godot States Statechart

## Core Concepts
Statechart with history.
- Add `parent_state` and `history_state`.
- Support hierarchical transitions.
