---
name: godot-retro-2d-gameplay-water-and-swimming
description: Godot Retro 2D Gameplay Water And Swimming
---

# Godot Retro 2D Gameplay Water And Swimming

## Core Concepts
Swimming state.
```gdscript
class_name WaterArea extends Area2D
