---
name: godot-gdscript-common-mistakes
description: Godot Gdscript Common Mistakes
---

# Godot Gdscript Common Mistakes

## Core Concepts
Common GDScript pitfalls.
- Forgetting `return` in typed functions.
- Using `yield` instead of `await`.
- Not using typed arrays for performance.
- Mixing `queue_free()` and `free()`.
- Forgetting `delta` in movement.
