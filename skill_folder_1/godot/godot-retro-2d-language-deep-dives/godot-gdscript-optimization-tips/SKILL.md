---
name: godot-gdscript-optimization-tips
description: Godot Gdscript Optimization Tips
---

# Godot Gdscript Optimization Tips

## Core Concepts
Performance in Godot 4.
- Use typed variables everywhere.
- Cache node references in `@onready`.
- Avoid `get_node()` in `_process`.
- Use `move_and_slide()` with CharacterBody2D.
- Prefer array/dict literals over repeated append.
