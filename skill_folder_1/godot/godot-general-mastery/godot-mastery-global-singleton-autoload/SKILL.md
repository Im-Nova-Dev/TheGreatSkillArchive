---
name: godot-mastery-global-singleton-autoload
description: Godot Mastery Global Singleton Autoload
---

# Godot Mastery Global Singleton Autoload
...
Autoload patterns.
```gdscript
# In project settings, add Autoload:
# - Game.gd
# - SignalBus.gd
# - SaveManager.gd
```
