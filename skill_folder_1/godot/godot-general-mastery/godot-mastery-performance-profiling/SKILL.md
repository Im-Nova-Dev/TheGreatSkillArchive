---
name: godot-mastery-performance-profiling
description: Godot Mastery Performance Profiling
---

# Godot Mastery Performance Profiling

## Core Concepts

## Core Concepts
Profile 2D with built-in tools.
- Debugger > Profiler
- Monitor > RAM/CPU
- Frame debugger
- Remote debug on device
