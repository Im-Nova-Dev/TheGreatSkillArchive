---
name: godot-mastery-editor-shortcuts
description: Godot Mastery Editor Shortcuts
---

# Godot Mastery Editor Shortcuts

## Core Concepts

## Core Concepts
Essential editor workflow.
- Ctrl/Cmd + B: run project
- F2: rename node
- Ctrl + D: duplicate
- Ctrl + M: toggle mute on AudioStreamPlayer
