---
name: godot-retro-sprite-atlas-and-spriteframes
description: Godot Retro Sprite Atlas And Spriteframes
---

# Godot Retro Sprite Atlas And Spriteframes

## Core Concepts

## Core Concepts
Using TextureAtlas for animation.
```gdscript
@onready var anim: AnimatedSprite2D = $AnimatedSprite2D

func play(idle: bool) -> void:
    if idle:
        anim.play("idle")
    else:
        anim.play("walk")
