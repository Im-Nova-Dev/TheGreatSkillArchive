---
name: godot-retro-parallax-backgrounds
description: Godot Retro Parallax Backgrounds
---

# Godot Retro Parallax Backgrounds

## Core Concepts

## Core Concepts
Multi-layer parallax for retro feel.
```gdscript
extends Parallax2D # ParallaxBackground in Godot 4

@export var speed := 0.5

func _process(delta: float) -> void:
    scroll_offset.x -= speed * 100.0 * delta
    if scroll_offset.x <= -1920:
        scroll_offset.x += 1920
```
