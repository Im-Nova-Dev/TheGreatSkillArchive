---
name: godot-retro-palette-and-color-limits
description: Godot Retro Palette And Color Limits
---

# Godot Retro Palette And Color Limits

## Core Concepts

## Core Concepts
Limited color palettes and palette swapping.
```gdscript
...
func _process(delta: float) -> void:
    ...
    mat.set_shader_parameter("index", palette_index)
```
