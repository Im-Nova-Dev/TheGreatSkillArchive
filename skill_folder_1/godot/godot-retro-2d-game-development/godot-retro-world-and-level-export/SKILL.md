---
name: godot-retro-world-and-level-export
description: Godot Retro World And Level Export
---

# Godot Retro World And Level Export

## Core Concepts

## Core Concepts
Exporting and packaging retro games.
```gdscript
# Export presets:
# - Windows: x86_64, icon.ico
# - HTML5: deterministic build
# - Linux: AppImage or standalone
# Configure in Project > Export menu.
```
