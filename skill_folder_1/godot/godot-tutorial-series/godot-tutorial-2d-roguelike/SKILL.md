---
name: godot-tutorial-2d-roguelike
description: Godot Tutorial 2D Roguelike
---

# Godot Tutorial 2D Roguelike
...
```gdscript
# BSP or cellular automata dungeon gen
# FOV with shadowcasting
# Permadeath and run-based progression
# Random loot tables
# ASCII fallback mode (optional)
```
