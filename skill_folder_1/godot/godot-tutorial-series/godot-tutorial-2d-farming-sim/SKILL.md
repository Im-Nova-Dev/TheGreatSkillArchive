---
name: godot-tutorial-2d-farming-sim
description: Godot Tutorial 2D Farming Sim
---

# Godot Tutorial 2D Farming Sim

## Core Concepts

## Core Concepts
Farming/life sim basics.
```gdscript
# Grid-based planting
# Time system (in-game day cycle)
# Inventory and shop
# Weather influence
# Save with JSON
```
