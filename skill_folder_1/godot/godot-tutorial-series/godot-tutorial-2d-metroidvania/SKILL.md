---
name: godot-tutorial-2d-metroidvania
description: Godot Tutorial 2D Metroidvania
---

# Godot Tutorial 2D Metroidvania
...
```gdscript
# Ability gating (double jump, dash, etc.)
# Map system (resourceless + discovered)
# Save rooms
# Boss with phases
# Backtracking logic
```
