---
name: godot-tutorial-2d-top-down-rpg
description: Godot Tutorial 2D Top Down Rpg
---

# Godot Tutorial 2D Top Down Rpg

## Core Concepts

## Core Concepts
Top-down RPG foundation.
```gdscript
# Player movement (4 or 8-direction)
# TileMap world
# NPC dialogue system
# Quest tracker
# Save/load system
