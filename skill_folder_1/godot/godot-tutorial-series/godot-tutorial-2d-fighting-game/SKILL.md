---
name: godot-tutorial-2d-fighting-game
description: Godot Tutorial 2D Fighting Game
---

# Godot Tutorial 2D Fighting Game

## Core Concepts

## Core Concepts
2D fighting game basics.
```gdscript
# State machine for characters
# Hitboxes and hurtboxes
# Combo system
# Input buffer
# Round and match system
```
