---
name: godot-tutorial-2d-co-op-multiplayer
description: Godot Tutorial 2D Co Op Multiplayer
---

# Godot Tutorial 2D Co Op Multiplayer
...
Local co-op in 2D.
```gdscript
# Input mapping for multiple devices
# Split screen (Viewport nodes)
# Shared world state
