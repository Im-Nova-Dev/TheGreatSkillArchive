---
name: godot-tutorial-2d-stealth-game
description: Godot Tutorial 2D Stealth Game
---

# Godot Tutorial 2D Stealth Game
...
```gdscript
# Vision cones (Area2D + polygon)
# Noise and distraction system
# Hiding spots
# Alert level and AI states
# Line of sight with RayCast2D
```
