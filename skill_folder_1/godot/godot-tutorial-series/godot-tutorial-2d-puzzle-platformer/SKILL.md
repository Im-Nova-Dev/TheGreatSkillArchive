---
name: godot-tutorial-2d-puzzle-platformer
description: Godot Tutorial 2D Puzzle Platformer
---

# Godot Tutorial 2D Puzzle Platformer
...
```gdscript
# Switching dimensions/worlds
# Time manipulation (record/playback)
