---
name: java-foreign-function-interface-ffm
description: Java Foreign Function Interface Ffm
---

# Java Foreign Function Interface Ffm

## Core Concepts

Key concepts and definitions for java-foreign-function-interface-ffm.
