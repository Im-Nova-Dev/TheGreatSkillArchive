---
name: event-driven-architecture-advanced
description: Event Driven Architecture Advanced
---
...
Key concepts and definitions for event-driven-architecture-advanced.
