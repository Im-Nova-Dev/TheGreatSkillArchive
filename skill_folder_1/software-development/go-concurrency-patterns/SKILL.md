{
  ...
  "description": "Teach Go concurrency beyond basics: worker pools, fan-out/fan-in, errgroup, semaphore patterns, cancellation, and pipeline design."
}

# Go Concurrency Patterns

Teach Go concurrency beyond basics: worker pools, fan-out/fan-in, errgroup, semaphore patterns, cancellation, and pipeline design.
