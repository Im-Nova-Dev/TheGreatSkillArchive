{
  ...
  "description": "Teach clean architecture: dependency inversion, use cases, interface adapters, entity layer, and framework independence."
}

# Clean Architecture

Teach clean architecture: dependency inversion, use cases, interface adapters, entity layer, and framework independence.
