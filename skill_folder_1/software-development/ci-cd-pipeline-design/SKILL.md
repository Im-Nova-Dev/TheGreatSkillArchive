{
  ...
  "description": "Teach CI/CD: pipeline stages, caching, artifacts, parallelization, failure handling, deployment strategies, and rollback."
}

# Ci Cd Pipeline Design

Teach CI/CD: pipeline stages, caching, artifacts, parallelization, failure handling, deployment strategies, and rollback.
