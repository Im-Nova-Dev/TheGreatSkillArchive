{
  ...
  "description": "Teach Go error handling: error wrapping, sentinel errors, custom types, error inspection, and error handling patterns in large codebases."
}

# Go Error Handling

Teach Go error handling: error wrapping, sentinel errors, custom types, error inspection, and error handling patterns in large codebases.
