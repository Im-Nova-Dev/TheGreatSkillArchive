{
  ...
  "description": "Teach shell scripting: bash/zsh, conditionals, loops, functions, error handling, argument parsing, and maintainable script structure."
}

# Shell Scripting Automation

Teach shell scripting: bash/zsh, conditionals, loops, functions, error handling, argument parsing, and maintainable script structure.
