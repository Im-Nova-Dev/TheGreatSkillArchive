{
  ...
  "description": "Teach Kubernetes operations: deployments, services, ingress, config maps, secrets, RBAC, operators, and troubleshooting."
}

# Kubernetes Operations

Teach Kubernetes operations: deployments, services, ingress, config maps, secrets, RBAC, operators, and troubleshooting.
